...
public class ExamplesApplication extends Application {
	...
	public static final Map<Category, ExampleItem[]> ITEMS = new HashMap<Category, ExampleItem[]>();
	public static final ArrayList<TeamMember> TEAM_MEMBERS = new ArrayList<TeamMember>();
